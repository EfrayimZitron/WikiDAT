...
def define_tables(dbengine):
    """
	Defines the tables used in the WIkiDAT database
	"""
...
def create_database(dbengine):
    """
	Creates the wikidb database. A storage engine is passed as an argument
	"""
    metadata = define_tables(dbengine)
